package word.puzzle.kata.service.setup;

import word.puzzle.kata.service.PuzzleSolver;
...
public class DataSetup {
    ...
    public PuzzleSolver setupRealPuzzle(){
        ...
        return new PuzzleSolver(new String[][]{
